...
public class TransportLeg7 {
    
    @SerializedName("tsp7Loc")
    @Expose
    private String tsp7Loc;
    ...
    public String getTsp7Loc() {
        return tsp7Loc;
    }
    
    public void setTsp7Loc(String tsp7Loc) {
        this.tsp7Loc = tsp7Loc;
    }
    ...
    public String toString() {
        ...
        sb.append(TransportLeg7.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tspLoc");
        sb.append('=');
        sb.append(((this.tsp7Loc == null) ? "<null>" : this.tsp7Loc));
        sb.append(',');
        ...
        sb.append(',');
        if (sb.charAt((sb.length() - 7)) == ',') {
            sb.setCharAt((sb.length() - 7), ']');
        } else {
            sb.append(']');
        }
        return sb.toString();
