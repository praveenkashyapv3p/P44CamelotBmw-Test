...
public class TransportLeg10 {
    
    @SerializedName("tsp10Loc")
    @Expose
    private String tsp10Loc;
    ...
    public String getTsp10Loc() {
        return tsp10Loc;
    }
    
    public void setTsp10Loc(String tsp10Loc) {
        this.tsp10Loc = tsp10Loc;
    }
    ...
    public String toString() {
        ...
        sb.append(TransportLeg10.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("tspLoc");
        sb.append('=');
        sb.append(((this.tsp10Loc == null) ? "<null>" : this.tsp10Loc));
        sb.append(',');
        ...
        sb.append(',');
        if (sb.charAt((sb.length() - 10)) == ',') {
            sb.setCharAt((sb.length() - 10), ']');
        } else {
            sb.append(']');
        }
        return sb.toString();
